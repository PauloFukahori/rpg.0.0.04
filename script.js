...
const CLASSES = {
    'Guerreiro do Leão': {
        ...
        attacks: [
            { id: 'ataqueBasico', name: "Ataque Básico", type: "physical", cost: 0, multiplier: 1.0, icon: "⚔️", description: "Ataque físico sem custo de MP." },
            { id: 'furia', name: "Fúria", type: "physical", cost: 10, multiplier: 1.8, icon: "💥", description: "Ataque físico poderoso que custa 10 MP." },
    ...
    'Mago Dracônico': {
        ...
        attacks: [
            { id: 'ataqueBasico', name: "Cajadada", type: "physical", cost: 0, multiplier: 0.7, icon: "🪄", description: "Ataque físico com cajado, sem custo de MP." },
    ...
    'Ladino das Ondas': {
        ...
        attacks: [
            { id: 'ataqueBasico', name: "Golpe Rápido", type: "physical", cost: 0, multiplier: 1.0, icon: "🗡️", description: "Ataque físico rápido sem custo de MP." },
            { id: 'ataqueRapido', name: "Estoque Duplo", type: "physical", cost: 5, multiplier: 0.8, icon: "⚔️", description: "Ataque com alta chance de acerto." },
    ...
    'Mino-Cristal': {
        description: 'Guerreiro minotauro com armadura de cristal. Defensor inabalável focado em resistência e proteção.',
        baseStats: { pv: 100, mp: 70, attack: 10, magic: 10, defense: 15, agility: 5 },
        image: 'assets/images/classes/mino-cristal.png',
        attacks: [
            { id: 'ataqueBasico', name: "Soco Básico", type: "physical", cost: 0, multiplier: 1.0, icon: "👊", description: "Ataque corpo a corpo sem custo de MP." },
    ...
    'Caçador Elemental': {
        ...
        attacks: [
            { id: 'ataqueBasico', name: "Flecha Simples", type: "physical", cost: 0, multiplier: 1.0, icon: "🏹", description: "Ataque com flecha básica sem custo de MP." },
...
function showGameOver() {
    ...
    actionsDiv.innerHTML = `
        <button class="action-button" onclick="changeScreen('title-screen'); location.reload();" style="background: linear-gradient(135deg, #ff4444, #cc0000); font-size: 1.2em; padding: 15px 30px;">
            🔄 Tentar Novamente
        </button>
    `;
}
...
function spawnMobsOnMap() {
    ...
    if (gameState.enemyKills >= requiredKills && !bossDefeated) {
        // Boss spawn no centro-direita
        spawnMobSprite(bossName, 55, 35, true);
    } else if (!bossDefeated) {
        // Sistema de 3 mobs obrigatórios em posições fixas
        ...
        // Spawnar exatamente 3 mobs
        for (let i = 0; i < 3; i++) {
            const pos = spawnPositions[i];
            const enemyName = phase.enemies[getRandomInt(0, phase.enemies.length - 1)];
